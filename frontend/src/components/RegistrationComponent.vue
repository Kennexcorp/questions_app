<template>
  ...
  <div class="container">
    <div class="card card-container">
      ...
      <form class="form-signin" role="form" method="post" action="http://localhost:8080/login_api/registration">
        ...
        <input v-model="user.passwordConfirm" type="password" id="inputPasswordConfirm" class="form-control" placeholder="Confirm Password" name="passwordConfirm" required>
...
<style scoped>
  ...
  body, html {
    height: 100%;
    background: linear-gradient(rgb(104, 145, 162), rgb(12, 97, 33)) no-repeat;
  }
